package com.example.tsukasa.robohon.customize;
...
public class ScenarioDefinitions {
     ...
     * Package名.
     */
    protected static final String PACKAGE = "com.example.tsukasa.robohon";
    /**
    ...
    public static final String ACC_Judge = ScenarioDefinitions.PACKAGE + ".judge.question";

    public static final String JudgeMode = PACKAGE + ".judgeMode";
